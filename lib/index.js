...
exports.search = function(keyword, cb) {
    request.get({ url: url + encodeURIComponent(keyword), json: true }, function(
        err,
        response,
        data
    ) {
...
exports.info = function(keyword, cb) {
    request.get({ url: show_url + encodeURIComponent(keyword), json: true }, function(
        err,
        response,
        data
    ) {
        ...
        if (data.hasOwnProperty('success') && !data.success)
            return cb(new Error('Package \'' + keyword + '\' not exist'));
